...
class VarDefParser ( Parser ):
    ...
    def vardef(self):
        ...
        try:
            ...
            vm=T.varPathMap.copy(); groupName=(None if localctx.name is None else localctx.name.text); T.varPathGroupMap[groupName]=vm;
            dm=T.varExprMap.copy(); groupName=(None if localctx.name is None else localctx.name.text); T.varExprGroupMap[groupName]=dm;	
    ...
    def var_path(self):
        ...
        try:
            ...
            name=(None if localctx.i is None else localctx.i.text); T.varPathMap[name]=t; 	
    ...
    def var_meta(self):
        ...
        try:
            ...
            if vn in T.varPathMap:
            	T.varPathMap[vn].metaData[pn]=(None if localctx.inf is None else self._input.getText((localctx.inf.start,localctx.inf.stop))); 
            else: 
            	T.varExprMap[vn].metaData[pn]=(None if localctx.inf is None else self._input.getText((localctx.inf.start,localctx.inf.stop))); 
    ...
    def stat(self):
        ...
        try:
            ...
            name=(None if localctx.i is None else localctx.i.text); T.varExprMap[name]=v; 	
